...
public class TelcomUser {
	...
	//private ArrayList callToNumbersSet;
	public TelcomUser(String phoneNumber){
		this.phoneNumber=phoneNumber;
     //	this.callToNumbersSet = new TreeSet();//单独收集被叫号码
     	//this.callToNumbersSet = new ArrayList();
	...
	private String getCallTophoneNumber(){
		return "15937201"+String.valueOf(new Random().nextInt(10))
